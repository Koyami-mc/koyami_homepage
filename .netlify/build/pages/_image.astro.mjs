...
import { A as AstroError, h as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, E as ExpectedImageOptions, i as ExpectedImage, j as ExpectedNotESMImage, k as InvalidImageService, r as resolveSrc, l as isRemoteImage, m as isESMImportedImage, n as isLocalService, D as DEFAULT_HASH_PROPS, o as ImageMissingAlt, f as AstroError$1, p as InvalidImageService$1, q as isRemoteAllowed } from '../chunks/astro/assets-service_DMZUDeBw.mjs';
import { c as createComponent, a as createAstro, r as renderTemplate, m as maybeRenderHead, b as addAttribute, s as spreadAttributes } from '../chunks/astro/server_Cniayb5w.mjs';
import 'clsx';
...
const JP2$1 = {
  validate(input) {
    if (readUInt32BE$1(input, 4) !== 1783636e3 || readUInt32BE$1(input, 0) < 1) return false;
...
const types = Array.from(typeHandlers$1.keys());
...
async function getConfiguredImageService$1() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_DMZUDeBw.mjs'
    ).then(n => n.t).catch((e) => {
...
}, "D:/koyami_homepage/node_modules/astro/components/Image.astro", void 0);
...
}, "D:/koyami_homepage/node_modules/astro/components/Picture.astro", void 0);
